...
public class Parent2PayerTest extends SeleniumACSC {
	public Parent2PayerTest(String inIdPattern, String inCloseEvent) {
		super(inIdPattern, inCloseEvent);
	}
	/*keep close
    @Parameters
    public static Collection<String[]> addParamter() {
    	return Arrays.asList(new String[][] { { "ACSC-P2Pa-0101", "keep" } });
    }*/
